...
class EditBar(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.gif_button = Button(self, text="GIF")
        ...
        self.gif_button.bind("<ButtonRelease>",self.gif_button_released)
        ...
        self.gif_button.pack(side=LEFT)
    ...
    def gif_button_released(self,event):
        filename = filedialog.askopenfilename()
